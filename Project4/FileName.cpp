...
void SignUp() {
    ...
    while (true) {
        ...
        cin.ignore();
        if (users[usercount].ID.length ()!= 14) {
            cout << " !!!! INVALIDE ID MUST BE 14 DIGIT " << endl;
            continue;
        }
        cout << "******************" << endl;
...
bool addNewAccount(int userindex) {
    ...
    while (true) {
        ...
        if (tempCard.length() !=16) {
            ...
            cout << "<<<<<INVALIDE NUMBER EXACTLY 16 DIGITS>>>>>" << endl;
            continue;
    ...
    while (true) {
        ...
        cout << " <<<<<<<INVALIDE !!!! MUST BE 3 DIGITS >>>>> " << endl;
...
void saveData() {
    ...
    for (int i = 0; i < usercount; i++) {
        ...
        for (int j = 0; j < users[i].accCount; j++) {
            ...
            file << users[i].Accounts[j].Cvv_Code << endl;
            file << users[i].Accounts[j].ExpirationDate << endl;
...
void loadData() {
    ...
    for (int i = 0; i < usercount; i++) {
        ...
        for (int j = 0; j < users[i].accCount; j++) {
            ...
            file >> users[i].Accounts[j].Cvv_Code;
            file.ignore();
